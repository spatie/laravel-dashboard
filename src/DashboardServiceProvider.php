...
class DashboardServiceProvider extends ServiceProvider
{
    public function boot()
    {
        $this->app->make(Dashboard::class)
            ->script(config('dashboard.scripts.alpinejs', 'https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.min.js'))
            ->stylesheet(config('dashboard.stylesheets.inter', 'https://rsms.me/inter/inter.css'))
