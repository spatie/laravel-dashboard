...
Inside the `x-dashboard` tag, you can use any of [available tiles](/docs/laravel-dashboard/v4/adding-tiles/overview). You can also [create your own tile](/docs/laravel-dashboard/v4/adding-tiles/creating-your-own-tile/).
