...
![Screenshot of dashboard](https://spatie.be/docs/laravel-dashboard/v4/images/dashboard.png)

The dashboard consists of tiles which are, under the hood, Livewire components. They can update themselves via polling. 

You can use any of the [pre-packaged tiles](/docs/laravel-dashboard/v4/adding-tiles/overview) or [create your own](/docs/laravel-dashboard/v4/adding-tiles/creating-your-own-tile).
